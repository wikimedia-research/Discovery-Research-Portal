...
subtitle: "(OR) Really? 279 visits in 22 minutes? And 526 clicks in one visit? How? Why?"
---
...
# library(extrafont); library(Cairo)
...
### Top sessions by number of clicks per session
...
events %>%
  ...
  knitr::kable(caption = "Counts of clicks per visit.")
```

### Top sessions by number of visits per session
...
events %>%
  ...
  arrange(desc(visits)) %>%
  knitr::kable(caption = "Top 10 sessions by number of visits from 13 May 2016 to 13 July 2016")
```

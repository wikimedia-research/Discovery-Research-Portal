...
![Figure 1: Pageviews to Ukrainian Wikipedia main page and other pages. ([Full resolution version](figures/pageviews_no-enwiki.png).)](figures/pageviews.png)
...
```{r bsts_aggregate_state_contribution_plots, fig.height = 20, fig.width = 16, fig.cap = "Figure 2: Plots of the 15 BSTS models' predictions (in black and gray) with actual pageviews (blue circles) for comparison."}
par(mfrow = c(5, 4))
